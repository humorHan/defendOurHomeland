 ...
 */
var GameOverLayerBigVictory = cc.Layer.extend({
    ctor: function(){
        this._super();
        ...
        this.runAction(seq);
        //添加胜利消息
        var message = new cc.LabelTTF("完胜","American Typewriter",50,"yellow",cc.TEXT_ALIGNMENT_LEFT);
        message.attr({
            x: 400,
            y: 300
        });
...
var GameOverSceneBigVictory = cc.Scene.extend({
    onEnter: function(){
        this._super();
        var gameOverLayerBigVictory = new GameOverLayerBigVictory();
        this.addChild(gameOverLayerBigVictory);
    }
});
