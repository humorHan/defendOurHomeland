 ...
 */
var GameOverLayerVictory = cc.Layer.extend({
    ctor: function(){
        this._super();
        ...
        this.runAction(seq);
        //添加胜利消息
        var message = new cc.LabelTTF("胜利","American Typewriter",50,"yellow",cc.TEXT_ALIGNMENT_LEFT);
        message.attr({
            x: 400,
            y: 300
        });
...
var GameOverSceneVictory = cc.Scene.extend({
    onEnter: function(){
        this._super();
        var gameOverLayerVictory = new GameOverLayerVictory();
        this.addChild(gameOverLayerVictory);
    }
});
